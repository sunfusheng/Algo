...
public class RemoveDuplicates {
    ...
    public static void main(String[] args) {
        LeetCodeUtil.logln("solution([1,1,2]) = " + solution1(new int[]{1, 1, 2}));
        LeetCodeUtil.logln("solution([0,0,1,1,1,2,2,3,3,4]) = " +
                solution1(new int[]{0, 0, 1, 1, 1, 2, 2, 3, 3, 4}));
        LeetCodeUtil.logln("officialSolution([1,1,2]) = " +
                officialSolution(new int[]{1, 1, 2}));
        LeetCodeUtil.logln("officialSolution([0,0,1,1,1,2,2,3,3,4]) = " +
                officialSolution(new int[]{0, 0, 1, 1, 1, 2, 2, 3, 3, 4}));
    }
}
