...
public class MaxProfitII {
    ...
    public static void main(String[] args) {
        ...
        LeetCodeUtil.logln("solution1([1, 7, 2, 3, 6, 7, 6, 7]) = " + MaxProfitII.solution1(prices));
        LeetCodeUtil.logln("solution2([1, 7, 2, 3, 6, 7, 6, 7]) = " + MaxProfitII.solution2(prices));
        LeetCodeUtil.logln("solution3([1, 7, 2, 3, 6, 7, 6, 7]) = " + MaxProfitII.solution3(prices));
    }
}
