...
public class IsSubsequence {
    ...
    public static void main(String[] args) {
        LeetCodeUtil.logln("solution1(abc,ahbgdc) = " + IsSubsequence.solution1("abc", "ahbgdc"));
        LeetCodeUtil.logln("solution1(axc,ahbgdc) = " + IsSubsequence.solution1("axc", "ahbgdc"));
        LeetCodeUtil.logln("solution2(abc,ahbgdc) = " + IsSubsequence.solution2("abc", "ahbgdc"));
        LeetCodeUtil.logln("solution2(axc,ahbgdc) = " + IsSubsequence.solution2("axc", "ahbgdc"));
    }
}
