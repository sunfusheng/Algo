...
public class SingleNumber {
    ...
    public static void main(String[] args) {
        ...
        LeetCodeUtil.logln("solution1(nums1) = " + solution1(nums1));
        LeetCodeUtil.logln("solution1(nums2) = " + solution1(nums2));
        LeetCodeUtil.logln("solution2(nums1) = " + solution2(nums1));
        LeetCodeUtil.logln("solution2(nums2) = " + solution2(nums2));
        LeetCodeUtil.logln("solution3(nums1) = " + solution3(nums1));
        LeetCodeUtil.logln("solution3(nums2) = " + solution3(nums2));
        LeetCodeUtil.logln("solution4(nums1) = " + solution4(nums1));
        LeetCodeUtil.logln("solution4(nums2) = " + solution4(nums2));
    }
}
