...
public class MaxProfit {
    ...
    public static void main(String[] args) {
        ...
        LeetCodeUtil.logln("solution1([7, 1, 5, 3, 6, 4]) = " + solution1(nums));
        LeetCodeUtil.logln("solution1([7, 6, 4, 3, 1]) = " + solution1(nums2));

        LeetCodeUtil.logln("solution2([7, 1, 5, 3, 6, 4]) = " + solution2(nums));
        LeetCodeUtil.logln("solution2([7, 6, 4, 3, 1]) = " + solution2(nums2));
    }
}
